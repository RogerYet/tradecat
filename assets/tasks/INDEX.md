...
| 0030 | sheets-symbol-query-hardening | Done | P0 | 修复/加固 sheets-service 币种查询子表：layout 变更样式不刷新、compact grid 裁剪触发 400、冻结条/表头错位；沉淀不变量与自检流程，避免“看起来服务挂了” | ./0030-sheets-symbol-query-hardening/ |
